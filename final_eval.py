...
wandb_logger = WandbLogger(project='MedEHR_Final',
                        ...
                        version=f"{config['backbone_name']}_{mode}_{config['job_id']}_{config['task']}_{config['version']}",
                        name=f"{config['backbone_name']}_{mode}_{config['job_id']}_{config['task']}_{config['version']}",
                        tags=[config['version'],config['task'],config['backbone_name'],'final']) 
