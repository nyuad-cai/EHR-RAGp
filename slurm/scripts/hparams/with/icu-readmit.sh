...
set -x
ORIG_DB=/scratch/sas10092/ehr-foundation/data/vectordbs/roformer/mean/within_stay_hist_full_1024_128
...
python w_hparams_opt.py \
    --config-path /scratch/sas10092/ehr-foundation/slurm/config/with_retrieval/hparams/icu-readmit/roformer.yaml \
